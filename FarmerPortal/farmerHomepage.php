                          ...
                          <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                               <?php
                                   if (isset($_SESSION['phonenumber'])) {
                                        ...
                                        echo "<a href='..' class='dropdown-item ' style='padding-right:-20px;'>Logout</a>";
                                   } else {
                ...
                <div class="container">
                     ...
                     <div class="row">
                          <div class="col-xs-12 col-sm-12 col-md-12 mt-2 mt-sm-2 text-center">
                               <p><u>AgroCraft Corporation</a></u> is a Multitrading Company for farmers and traders</p>
                               <p class="h6">Copy All right Reversed.<a class="text-green ml-2" target="_blank">Agrotech</a></p>
                          </div>
                          </hr>
                     </div>
                </div>
